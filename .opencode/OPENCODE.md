# cpp-http-server — Инструкции для Open Code
...
- **[cpp-style.md](rules/cpp-style.md)** — C++17 стандарт, naming, память, header organization
- **[architecture.md](rules/architecture.md)** — структура файлов, интерфейсы vs реализации, доменные папки
